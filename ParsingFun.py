# Возвращает текстовый файл с списком ссылок на все новости за все года с сайта економ правда
...
sitemap_url = 'https://www.epravda.com.ua/sitemap/sitemap-archive.xml'
